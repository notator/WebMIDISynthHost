...
WebMIDI.residentWAFSynth = (function(window)
{
	...
	let
		// This is a copy of the WebAudioFontReverberator at
		// https://github.com/surikov/webaudiofont/blob/master/npm/src/reverberator.js
		WebAudioFontReverberator = function(audioContext)
		{
			var me = this;
			...
			this.dry.gain.setTargetAtTime(0.9, 0, 0.0001); // original 1st arg was 0.9. very dry: 1, very wet: 0.01
			this.dry.connect(this.output);
			this.wet = audioContext.createGain();
			this.wet.gain.setTargetAtTime(0.5, 0, 0.0001); // original 1st arg was 0.5. very dry: 0.01, very wet: 1
	...
	ResidentWAFSynth.prototype.open = function()
	{
		...
		for(var i = 0; i < 16; i++)
		{
			...
			let channelPanNode = audioContext.createStereoPanner(),
				channelReverberator = new WebAudioFontReverberator(audioContext),
	...
	ResidentWAFSynth.prototype.allSoundOff = function()
	{
